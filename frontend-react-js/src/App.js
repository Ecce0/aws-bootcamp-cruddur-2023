...
const params = {
  ...
  "aws_user_pools_id": "us-east-1_GHUR3Uvsf",
  "aws_user_pools_web_client_id": "6ueligdf6dsbo7cu7j8kiig1s",
  "oauth": {},
  Auth: {
    // We are not using an Identity Pool
    // identityPoolId: process.env.REACT_APP_IDENTITY_POOL_ID, // REQUIRED - Amazon Cognito Identity Pool ID
    region: "us-east-1",           // REQUIRED - Amazon Cognito Region
    userPoolId: "us-east-1_GHUR3Uvsf",         // OPTIONAL - Amazon Cognito User Pool ID
    userPoolWebClientId: "6ueligdf6dsbo7cu7j8kiig1s",   // OPTIONAL - Amazon Cognito Web Client ID (26-char alphanumeric string)
  }
}
